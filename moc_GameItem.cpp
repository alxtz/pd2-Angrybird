...
#include "GameScene/AbsClasses/GameItem.h"
...
QT_MOC_LITERAL(1, 9, 9), // "updatePos"
QT_MOC_LITERAL(2, 19, 0) // ""

    },
    "GameItem\0updatePos\0"
};
...
void *GameItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "QGraphicsPixmapItem"))
        return static_cast< QGraphicsPixmapItem*>(const_cast< GameItem*>(this));
