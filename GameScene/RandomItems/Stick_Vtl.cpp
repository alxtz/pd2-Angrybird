...
Stick_Vtl::Stick_Vtl(b2World * inputWorld , int inputX , int inputY)
{
    //基本設定
    setPixmap(QPixmap("./GameData/DefaultResources/Images/stick_vtl.png"));
    inWorld = inputWorld;
...
void Stick_Vtl::updatePos()
{
    ...
    if(health<2)
    {
        setPixmap(QPixmap("./GameData/DefaultResources/Images/stick_vtl_hurt"));
    }
    if(health<=0)
    {
